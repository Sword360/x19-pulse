...
export function AddServerModal({ 
  ...
  const githubInstallCommand = `curl -fsSL https://raw.githubusercontent.com/Sword360/x19-pulse/test/vnc-architecture/agent/install.sh -o install.sh && sudo bash install.sh ${activeServerUrl} ${agentToken}`;
